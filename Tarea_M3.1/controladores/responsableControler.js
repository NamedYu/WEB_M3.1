    ...
    if (index !== -1) {
        ...
        if(listaUbicaciones.findIndex(ubicacion => ubicacion.id == id)!=-1){
            ...
            const responsableActualizado = {
                id:id || listaResponsables[index].id,
                numeroEmpleado: numeroEmpleado || listaResponsables[index].numeroEmpleado,
                nombre: nombre || listaResponsables[index].nombre,
                activosEnCustodia: activosEnCustodia || listaResponsables[index].activosEnCustodia,
                imagen: imagen || listaResponsables[index].imagen
            };
